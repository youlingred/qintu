<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./themes/qintu/wap/goods_qdz_list.html";i:1499077434;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\header.html";i:1497792156;s:67:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\nav.html";i:1498742812;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\footer.html";i:1497792156;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<img class="img-responsive" src="<?php echo config('theme_path'); ?>/wap/images/banner_qdz.jpg?ver=<?php echo __VERSION__; ?>">
<a name="pos"></a>
				...
				<?php if(is_array($data) || $data instanceof \think\Collection): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;
					...
					if($categoryInfos[$i-1]['name'] == $vo['name']): ?>
						<li role="presentation" class="active">
							<a role="menuitem" tabindex="-1" href="<?php echo url('goods/lists?category='.$url_str.$url_filter.$url_search.$url_sort); ?>#pos"><?php echo $vo['name']; ?></a>
						</li>
                    <?php else: ?>    
				...
				<a href="<?php echo url('goods/detail?id='.$data['id']); ?>">
					<div class="thumbnail">
                        ...
                        <?php endif; 
			  			...
			  			?>
                        <p class="item-overlay text-center"><?php echo $price_txt; ?>日元起</p>
