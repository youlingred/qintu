<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\phpStudy\WWW\minishop/application/admin\view\base\login.html";i:1491877602;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>亲途旅游网-系统后台登录</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b style="color:white">亲途后台管理系统</b></a>
  </div>
  <!-- /.login-logo -->
