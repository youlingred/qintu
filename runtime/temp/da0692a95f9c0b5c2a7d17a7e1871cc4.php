<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"D:\phpStudy\WWW\minishop/application/admin\view\order\index.html";i:1495282291;s:64:"D:\phpStudy\WWW\minishop/application/admin\view\common\head.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\header.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\navbar.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\footer.html";i:1490783690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="box-header with-border">
             ...
             <!--  </select>
              ...
              <select class="form-control input-sm filterStatus" name="status">
                ...
                <option value="nopaid">未提交</option>
                <option value="paid">已提交</option>
              </select>
              </div>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <td><a href="<?php echo url('order/detail',['id'=>$list['order_no']]); ?>"><?php echo date("Y-m-d H:i:s",$list['createtime']); ?></a></td>
                    <!--<td><?php switch($list['status']): case "nopaid": ?><span class="label label-danger">未提交</span><?php break; case "paid": ?><span class="label label-success">已提交</span><?php break; case "shipped": ?><span class="label label-success">已发货</span><?php break; case "completed": ?><span class="label label-success">已完成</span><?php break; case "cancel": ?><span class="label label-primary">用户取消</span><?php break; case "delete": ?><span class="label label-warning">用户删除</span><?php break; endswitch; ?></td>-->
