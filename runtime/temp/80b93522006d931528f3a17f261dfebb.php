<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:39:"./themes/qintu/wap/goods_ztdz_list.html";i:1495603405;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\header.html";i:1495515164;s:67:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\nav.html";i:1495595875;s:79:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\post-why-choose.html";i:1495519127;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\footer.html";i:1495515140;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
	<meta charset="utf-8" />
...
<style type="text/css">
	...
	/*body{
		background-image: url("<?php echo config('theme_path'); ?>/wap/images/banner_ztdz.jpg");
		background-size:contain;
		background-repeat: no-repeat;
	}*/
</style>
<img class="img-responsive" src="<?php echo config('theme_path'); ?>/wap/images/banner_ztdz.jpg?ver=<?php echo __VERSION__; ?>">
...
<div class="row section-bg-gray section">
 ...
 <img src="<?php echo config('theme_path'); ?>/wap/images/ztdz_banner_2.jpg" width="100%	">
  <a href="<?php echo url('article/page?name=srdz'); ?>"><button type="button" class="btn btn-lg btn-default" style="top: 60%;
    left: 45%;
    position: absolute;
    background: rgba(0,0,0,0.0);
    color: #FFF;">立刻预约</button></a>
 </div>
</div>
