<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"D:\phpStudy\WWW\minishop/application/admin\view\goods\filteredit.html";i:1492403999;s:64:"D:\phpStudy\WWW\minishop/application/admin\view\common\head.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\header.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\navbar.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\footer.html";i:1490783690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
              ...
              <form role="form" id="addCategoryForm" action="<?php echo url('filterEdit'); ?>" method="post">
                <div class="box-body">
                  <div class="form-group">
                  	 <input name="id" value="<?php echo $goodsFilterInfo['id']; ?>" type="text" hidden="hidden">
                    <label for="exampleInputEmail1">名称</label>
                    <input class="form-control" name="name" value="<?php echo $goodsFilterInfo['name']; ?>" placeholder="这将是它在站点上显示的名字" type="text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">别名</label>
                    <input class="form-control" name="slug" value="<?php echo $goodsFilterInfo['slug']; ?>" placeholder="“别名”是在URL中使用的别称，它可以令URL更美观" type="text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">父节点</label>
                    <select class="form-control select" name="pid">
                      <option value="0">无</option>
                      <?php echo goods_category_tree_to_select($goodsFilterTree); ?>
                    </select>
                  </div>
                </div>
                <!-- /.box-body -->
...
<script type="text/javascript">
  ...
  // 设置select选中
  $(".select").val("<?php echo $goodsFilterInfo['pid']; ?>");
</script>
