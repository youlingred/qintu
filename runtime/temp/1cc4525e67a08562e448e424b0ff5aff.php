<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"./themes/qintu/index/page_qtlp_hsps.html";i:1498186999;s:72:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\header.html";i:1497783158;s:69:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\nav.html";i:1498742819;s:77:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\post-hunpai.html";i:1497627776;s:72:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\footer.html";i:1497781935;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<?php
	$product1_list=_get_goods_best_list('qtlp_hsps',6,'sortup');
	$man_list=_get_goods_list('qtlp_hpdr',4,'sortup');
	$product2_list=_get_goods_hot_list('qtlp_hsps',3,'sortup');
	$product3_list=_get_goods_list('qtlp_hp_bottoms',4,'sortup');
	$post = _get_post_by_name('post-hptc');
?>
<style type="text/css">
	.col-sm-3,
	.col-sm-4 {
...
<img class="img-responsive" src="<?php echo config('theme_path'); ?>/index/images/banner_hsps.jpg?ver=<?php echo __VERSION__; ?>">
<div class="row section-bg-white section-one">
	<div class="col-md-8 col-md-offset-2 title-one">
		...
		<div id="notice_content" style="display:none;padding: 0 50px;"><?php echo $post['content']; ?></div>
	</div>
</div>
</div>
...
<div class="row section-bg-white section no-padding">
	<div class="col-md-8 col-md-offset-2 title-one">
		<p class=" title-two">摄影作品
			<a href="<?php echo url('goods/lists?category=qtlp_hsps'); ?>"><span class="txt-lookmore">更多作品>></span></a></p>
		<div class="row">
...
<div class="row section-bg-gray section">
	<div class="col-md-8 col-md-offset-2 title-one text-center">
		<img src="<?php echo config('theme_path'); ?>/index/images/hsps_banner_2.jpg?ver=<?php echo __VERSION__; ?>" width="100%	">
		<a href="<?php echo url('article/page?name=lxgp'); ?>">
			<button type="button" class="btn btn-lg btn-default" style="top: 60%;
    left: 45%;
    position: absolute;
    background: rgba(0,0,0,0.0);
    color: #FFF;">旅行跟拍</button>
		</a>
	</div>
</div>
	...
	<div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 title-one">
		...
		<div class="row">
			<div class="col-sm-8">
					<div class="modal-content">
						<div class="modal-body">
							<form id="form-need" class="person-form" action="<?php echo url('index/postHunpai'); ?>">
								<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea name="description" rows="2" placeholder="我要咨询婚纱拍摄" class="form-control"></textarea>
								</div>
