<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\phpStudy\WWW\minishop/application/admin\view\config\add.html";i:1492398153;s:64:"D:\phpStudy\WWW\minishop/application/admin\view\common\head.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\header.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\navbar.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\footer.html";i:1490783690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="tab-content">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">设置名称</label>
                  <input type="text" class="form-control" id="key" name="name" value="" placeholder="设置的关键字，必须是英文或下划线，如:web_site_icp" />
                </div>
                <!--<div class="form-group">
                  <label for="exampleInputPassword1">设置描述</label>
                  <input type="text" class="form-control" id="description" value="" name="description" placeholder="对此项设置的详细描述" />
                </div>-->
                <div class="form-group">
                  <label for="exampleInputPassword1">默认值(可为空)</label>
                  <input type="text" class="form-control" id="value" value="" name="value" placeholder="此项设置默认值">
                </div>                              
