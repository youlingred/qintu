<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"./themes/qintu/index/page_srdz.html";i:1498197989;s:72:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\header.html";i:1497783158;s:69:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\nav.html";i:1498742819;s:72:"D:\phpStudy\WWW\minishop/application/index\view\public\qintu\footer.html";i:1497781935;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<link href="<?php echo config('theme_path'); ?>/index/css/cityPicker.css?ver=<?php echo __VERSION__; ?>" rel="stylesheet" type="text/css">
<style>
      ...
      <div class="modal-body">
     	 <form id="form-need" class="person-form" action="<?php echo url('index/postPerson'); ?>">
			...
			<div class="form-group">
				...
				<input id="cityChoice" type="text" class="form-control" name="reached" 
					   placeholder="请输入目的地">
			</div>
			<div class="form-group">
...
<!-- 需求框结束-->
 ...
 <img class="img-responsive" src="<?php echo config('theme_path'); ?>/index/images/banner_srdz.jpg?ver=<?php echo __VERSION__; ?>">
...
<script src="<?php echo config('theme_path'); ?>/index/js/page_srdz.js?ver=<?php echo __VERSION__; ?>"></script>
<script src="<?php echo config('theme_path'); ?>/index/js/cityData.js?ver=<?php echo __VERSION__; ?>"></script>
<script src="<?php echo config('theme_path'); ?>/index/js/cityPicker.js?ver=<?php echo __VERSION__; ?>"></script>
<script>
