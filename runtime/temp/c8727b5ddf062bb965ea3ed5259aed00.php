<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:36:"./themes/qintu/wap/goods_detail.html";i:1499076218;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\header.html";i:1497792156;s:67:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\nav.html";i:1498742812;s:73:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\post-cost.html";i:1495509057;s:77:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\post-question.html";i:1495509057;s:78:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\post-cost-ztdz.html";i:1495509057;s:82:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\post-question-ztdz.html";i:1495509057;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\footer.html";i:1497792156;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<!--<a><div id="car_container" class="pull-right bag-right <?php if($top_cate_info['slug'] == 'ztdz'): ?>hidden<?php endif; ?>" id="bag">
...
.commont .commont-content{
	...
	<div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 title-one section-bg-white <?php if($top_cate_info['slug'] == 'qtdr'): ?>hidden<?php endif; ?>" style="top: 10px;">
		...
		<div class="carousel-inner" role="listbox">
			<?php if(!(empty($data['photo_path_1']) || ($data['photo_path_1'] instanceof \think\Collection && $data['photo_path_1']->isEmpty()))): ?>
				<div class="item active">
					<div class="item">
						<img class="center-block img-responsive" src="<?php echo root_path(); ?><?php echo $data['photo_path_1']; ?>"> </div>
				</div>
			<?php endif; if(!(empty($data['photo_path_2']) || ($data['photo_path_2'] instanceof \think\Collection && $data['photo_path_2']->isEmpty()))): ?>
				<div class="item">
					<div class="item">
						<img class="center-block img-responsive" src="<?php echo root_path(); ?><?php echo $data['photo_path_2']; ?>"> </div>
				</div>
			<?php endif; if(!(empty($data['photo_path_3']) || ($data['photo_path_3'] instanceof \think\Collection && $data['photo_path_3']->isEmpty()))): ?>
				<div class="item">
					<div class="item">
						<img class="center-block img-responsive" src="<?php echo root_path(); ?><?php echo $data['photo_path_3']; ?>"> </div>
				</div>
			<?php endif; ?>
		</div>
	</div>
		...
		<div class="col-sm-7 product-card-right">
		  	...
		  	<div class="row">
		  		<div class="col-sm-12">
		  			<?php 
		  			 ...
		  			 ?>
		  			<p id="price_txt" class="product-detail-title txt-red" data-rmb="<?php echo $price_rmb; ?>"><?php echo $price_txt; ?>日元<small>人/起</small></p>
		  		</div>
		  	...
		  	<div class="row hidden">
				...
				<div class="col-sm-12 sum_btns text-right">
                    <button id="addOrder" type="button" class="btn btn-gold" dataname="<?php echo $data['name']; ?>" dataid="<?php echo $data['id']; ?>">加入心愿单</button>
				</div>
			</div>
		</div>
	  </div>
...
<?php if($top_cate_info['slug'] == 'qtdr'): ?>
	<div class="row section qtdr-section-top text-center">
		...
		<div class="caption text-center" style="margin-top: 20px;">
			<p class="c-title" style="font-weight: bold"><?php echo $data['name']; ?><span style="font-weight: normal;font-size: 14px;">&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo config('theme_path'); ?>/index/images/yanzheng.png"/>已验证</span></p>		
			        ...
			        <div class="col-sm-12 content">
			        	...
			        	<?php if(is_array($shares) || $shares instanceof \think\Collection): $i = 0; $__LIST__ = $shares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;
							...
							if(($price_txt/10000)>1){
				  			 ...
				  			 ?>
				        	<div class="share">
				        		<p class="title"><?php echo $vo['name']; ?><a href="<?php echo url('goods/detail?id='.$vo['id']); ?>"><span class="txt-lookmore"><button type="button" class="btn btn-md btn-gold btn-circle">查看体验</button></span></a></p>
				        		<p class="price"><?php echo $price_txt; ?>日元</p>
		  ...
		  <a href="<?php echo url('goods/detail?id='.$vo['id']); ?>">
			  <div class="thumbnail thumbnail-qdz-detail-bottom">
			  	<?php if(empty($vo['cover_path']) || ($vo['cover_path'] instanceof \think\Collection && $vo['cover_path']->isEmpty())): ?>
					<img src="<?php echo config('theme_path'); ?>/wap/images/Thumbnail_Placeholder.png" alt="<?php echo $vo['name']; ?>">
				<?php else: ?>
...
<div class="order-container text-center <?php if($top_cate_info['slug'] == 'qtdr'): ?>hidden<?php endif; ?>">
	<div class="btn-group btn-group-lg <?php if($top_cate_info['slug'] == 'ztdz'): ?>hidden<?php endif; ?>" style="width: 90%;">
	    <button id="lookOrder" type="button" class="btn btn-gold btn-50">查看全部心愿单</button>
	    <button id="addOrder_btn" type="button" class="btn btn-danger btn-50">申请预订</button>
	</div>
	<button id="postOrder" type="button" class="btn btn-lg btn-gold btn-90  <?php if($top_cate_info['slug'] != 'ztdz'): ?>hidden<?php endif; ?>">申请预订</button>
</div>
<script src="<?php echo config('theme_path'); ?>/wap/js/goods_detail.js?ver=<?php echo __VERSION__; ?>"></script>