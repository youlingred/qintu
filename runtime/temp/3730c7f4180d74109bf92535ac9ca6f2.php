<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./themes/qintu/wap/page_about.html";i:1495515034;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\header.html";i:1495515164;s:67:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\nav.html";i:1495517511;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\footer.html";i:1495515140;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
	<meta charset="utf-8" />
...
<?php 
	$list=_get_posts_by_term('about');
 ?>
<div class="row section-bg-gray section">
<div class="col-md-6 col-md-offset-3 section-bg-white section-about">
   <div role="tabpanel">
    <ul class="nav nav-tabs" role="tablist">
    	<?php if(is_array($list) || $list instanceof \think\Collection): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if($k == '1'): ?>
    		   <li role="presentation" class="active"><a href="#<?php echo $vo['name']; ?>" data-toggle="tab" role="tab" aria-controls="tab<?php echo $k-1; ?>"><?php echo $vo['title']; ?></a></li>
    		<?php else: ?>
    			 <li role="presentation"><a href="#<?php echo $vo['name']; ?>" data-toggle="tab" role="tab" aria-controls="tab<?php echo $k-1; ?>"><?php echo $vo['title']; ?></a></li>
    		<?php endif; endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <div id="tabContent1" class="tab-content">
    	<?php if(is_array($list) || $list instanceof \think\Collection): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if($k == '1'): ?>
      		<div role="tabpanel" class="tab-pane fade in active" id="<?php echo $vo['name']; ?>">
      	<?php else: ?>
    		<div role="tabpanel" class="tab-pane fade in" id="<?php echo $vo['name']; ?>">
		<?php endif; ?>
         <img width="100%" src="<?php echo config('theme_path'); ?>/wap/images/about_pic_<?php echo $k; ?>.jpg?ver=<?php echo __VERSION__; ?>"> 
