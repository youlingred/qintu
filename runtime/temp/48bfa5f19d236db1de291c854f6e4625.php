<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:29:"./themes/qintu/wap/index.html";i:1498742849;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\header.html";i:1497792156;s:67:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\nav.html";i:1498742812;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\banner.html";i:1496053336;s:70:"D:\phpStudy\WWW\minishop/application/wap\view\public\qintu\footer.html";i:1497792156;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<div id="carousel" class="carousel slide" data-ride="carousel">
	<ol class="carousel-indicators">
        ...
        ->where("a.status",1)->where("a.position",3)
...
<?php
	$qdz_hot_list=_get_goods_hot_list('qdz',3,'sortup');
...
<div class="row section-bg-white section">
	<div class="col-md-8 col-md-offset-2 title-one">
		  ...
		  <p class="text-center txt">让平凡的人去走马观花，这里只有纯粹的异地生活方式，让你深入民间结交良师益友，有空来亲途看看。</p>
	  ...
	  <div class="row">
	  	<?php if(is_array($qdz_hot_list) || $qdz_hot_list instanceof \think\Collection): $i = 0; $__LIST__ = $qdz_hot_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<div class="col-sm-4">
...
<div class="row section-bg-gray section">
  <div class="col-md-8 col-md-offset-2 title-one">
    <p class="text-center title">旅行+ 不简单的是旅行</p>
	...
	<?php endforeach; endif; else: echo "" ;endif; ?>
	<!--<p class="text-center title"><a href="<?php echo url('article/page?name=srdz'); ?>"><span><button type="button" class="btn btn-lg btn-gold">预约我的旅行</button></span></a></a></p>
    </div>
		...
		<div class="col-sm-4">
		  <a href="<?php echo url('goods/detail?id='.$vo['id']); ?>">
			  <div class="thumbnail">
		        ...
		        <?php endif; ?>
			  		<div>
						<img class="mark-png" src="<?php echo config('theme_path'); ?>/wap/images/hot.png"/>
						<div class="caption text-center">
						  <p class="c-title"><?php echo $vo['name']; ?></p>	
		  				 <p class="description"><?php echo $vo['description']; ?></p>
						</div>
