<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\phpStudy\WWW\minishop/application/admin\view\post\add.html";i:1490931486;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\header.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\navbar.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\footer.html";i:1490783690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <input id="name" name="name" class="form-control" placeholder="别名">
              </div>
              <!--<div class="form-group">
                <input id="name" name="description" class="form-control" placeholder="描述">
              </div>-->
              <div class="form-group">
