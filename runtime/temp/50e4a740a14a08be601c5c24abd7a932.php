<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\phpStudy\WWW\minishop/application/admin\view\post\index.html";i:1490931657;s:64:"D:\phpStudy\WWW\minishop/application/admin\view\common\head.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\header.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\navbar.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\footer.html";i:1490783690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <table class="table table-hover table-striped">
                  ...
                  <?php if(is_array($postsList) || $postsList instanceof \think\Collection): $i = 0; $__LIST__ = $postsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                      ...
                      <td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></td>
                      <!--<td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo $vo['description']; ?></a></td>-->
                      ...
                      <td>
                        <?php switch($vo['status']): case "publish": ?>                            
                            <a type="button" class="btn btn-sm btn-warning ajax-get" href="<?php echo url('post/setstatus',['ids'=>$vo['id'],'status'=>'pending']); ?>">禁用</a>&nbsp;&nbsp;
                            <a type="button" class="btn btn-sm btn-danger ajax-get confirm" href="<?php echo url('post/setstatus',['ids'=>$vo['id'],'status'=>'trash']); ?>">删除</a>
                          <?php break; case "pending": ?>
                            <a type="button" class="btn btn-sm btn-success ajax-get" href="<?php echo url('post/setstatus',['ids'=>$vo['id'],'status'=>'publish']); ?>">启用</a>&nbsp;&nbsp;
                            <a type="button" class="btn btn-sm btn-danger ajax-get confirm" href="<?php echo url('post/setstatus',['ids'=>$vo['id'],'status'=>'trash']); ?>">删除</a>
                          <?php break; case "trash": ?>
                            <a type="button" class="btn btn-sm btn-primary ajax-get" href="<?php echo url('post/setstatus',['ids'=>$vo['id'],'status'=>'publish']); ?>">还原</a>&nbsp;&nbsp;
                            <a type="button" class="btn btn-sm btn-danger ajax-get confirm" href="<?php echo url('post/setstatus',['ids'=>$vo['id'],'status'=>'delete']); ?>">彻底删除</a>
