<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"D:\phpStudy\WWW\minishop/application/admin\view\goods\filter.html";i:1492491163;s:64:"D:\phpStudy\WWW\minishop/application/admin\view\common\head.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\header.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\navbar.html";i:1490584772;s:66:"D:\phpStudy\WWW\minishop/application/admin\view\common\footer.html";i:1490783690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="col-md-4">
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <form role="form" id="addCategoryForm" action="<?php echo url('filterEdit'); ?>" method="post">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="pid">
                     ...
                     <?php echo goods_category_tree_to_select($goodsFilterSelectTree); ?>
                    </select>
                  </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                  <div id="addCategoryFormSubmit" class="btn btn-primary">添加新筛选标签</div>
                </div>
              </form>
            </div>
            <!-- /.box-body -->
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tbody>
                  	 <?php if(empty($_GET['name']) || ($_GET['name'] instanceof \think\Collection && $_GET['name']->isEmpty())): ?>
                        <?php echo goods_filter_tree_to_view($goodsFilterTree); else: if(is_array($goodsFilterList) || $goodsFilterList instanceof \think\Collection): $i = 0; $__LIST__ = $goodsFilterList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          <tr>
                            <td><input type='checkbox' name='ids' <?php echo get_checkbox_status($vo['id']); ?> value=<?php echo $vo['id']; ?>'></td>
                            <td class='mailbox-name'><a href='<?php echo url('filterEdit',['id'=>$vo['id']]); ?>'><?php echo $vo['name']; ?></a></td>
  ...
  $('document').ready(function (argument) {
    ...
    $('.setStatusSubmit').click(function () {
      ...
      $.ajax({
        cache: true,
        type: "POST",
        url : '<?php echo url('filterSetstatus'); ?>',
